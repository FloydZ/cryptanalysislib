...
TEST(AVLTree, InsertAtBeginning) {
	AvlTreeList<const char*> list;
...
TEST(AVLTree, InsertManyBeginning) {
	const long N = 300000;
...
TEST(AVLTree, InsertManyEveryWhere) {
	const int N = 18;
...
TEST(AVLTree, CPPVectorEverywhere) {
