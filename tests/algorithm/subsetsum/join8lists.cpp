...
TEST(SubSetSum, join8lists_twolists_on_iT_v2_hashmap_constexpr) {
	Matrix A; A.random();
	constexpr uint64_t k_lower1=0, k_higher1=n/3;
	constexpr uint64_t k_lower2=k_higher1, k_higher2=2*n/3;
	constexpr uint64_t k_lower3=k_higher2, k_higher3=n;
	...
	constexpr static SimpleHashMapConfig simpleHashMapConfigL2 {
			100, 1ul<<(k_higher3-k_lower3), 1
	};
	...
	using HML2 = SimpleHashMap<D,      F, simpleHashMapConfigL2, Hash<D, k_lower3, k_higher3, 2>>;
	HML0 *hml0 = new HML0{};
	HML1 *hml1 = new HML1{};
	HML2 *hml2 = new HML2{};
