...
constexpr static NN_Config config{256, 4, 200, 64, LS, dk, d, 0, 512};
NN<config> algo{};
...
BENCHMARK(BM_simd_sort_nn_on64_simple_0)->RangeMultiplier(2)->Range(1024, 1u << 18)->Complexity();
BENCHMARK(BM_simd_sort_nn_on64_simple_1)->RangeMultiplier(2)->Range(1024, 1u << 18)->Complexity();
BENCHMARK(BM_simd_sort_nn_on64_0)->RangeMultiplier(2)->Range(1024, 1u << 18)->Complexity();
BENCHMARK(BM_simd_sort_nn_on64_1)->RangeMultiplier(2)->Range(1024, 1u << 18)->Complexity();
BENCHMARK(BM_simd_sort_nn_on_double64_0)->RangeMultiplier(2)->Range(1024, 1u << 18)->Complexity();
